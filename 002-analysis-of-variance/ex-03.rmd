...
Before analyzing the data it is best to "stack" the data into two columns, 
a response column "y" and a city factor column "city". By
using the `stack()` function in R you can restructure the city data by
